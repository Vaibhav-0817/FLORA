...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section} my-8`}>
      <h2 className="text-3xl text-white font-bold mb-8 font-Roboto">FAQ</h2>
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-400">
                ...
                us at support@Flora.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-400">
                ...
                support@Flora.com, or by calling us at (+91) 7291906057
