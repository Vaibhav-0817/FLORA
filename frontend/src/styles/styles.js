const styles = {
    ...
    productDiscountPrice:"font-bold text-[18px] text-gray-900 font-Roboto",
    price:"font-[500] text-[16px] text-gray-900 pl-3 mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-pink-500 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-pink-500",
