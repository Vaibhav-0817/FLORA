    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center">
          <BsFillBagFill size={30} color="#ec0484" />
          <h1 className="pl-2 text-[25px] font-Roboto text-white">
            Order Details
          </h1>
        </div>
      </div>
        ...
        data?.cart.map((item, index) => (
          <div className="w-full flex items-start mb-5">
            ...
            <div className="w-full">
              ...
              <h5 className="pl-3 text-[20px] text-[#fff]">
      ...
      {open && (
        <div className="w-full top-0 left-0 fixed h-screen z-50 bg-[#0005] flex items-center justify-center">
          <div className="w-1/2 h-min bg-white shadow rounded-md p-3">
      ...
      <div className="w-full 800px:flex items-center text-white">
